          ...
          <table className="dc-charges__table">
            ...
            <tbody>
              <tr>
                ...
                <td><DirhamIcon size={14} color="#000" />{selectedType?.fees ?? config.charges}</td>
              </tr>
            </tbody>
            <tfoot>
              <tr>
                <td><strong>Total Amount</strong></td>
                <td><strong><DirhamIcon size={14} color="#000" />{selectedType?.fees ?? config.charges}</strong></td>
              </tr>
            </tfoot>
          </table>
        </div>
                ...
                <div style={{ width: '100%', display: 'flex', gap: 12, alignItems: 'stretch' }}>
                  ...
                  <div className="dc-basic-info-card" style={{ flex: 1 }}>
                    ...
                    <div className="dc-basic-info-card__body">
                      ...
                      <span className="dc-basic-info-card__value dc-basic-info-card__value--charge">{config.charges}</span>
                    </div>
                  </div>
                </div>
                ...
                <div style={{ width: '100%', display: 'flex', gap: 12, alignItems: 'center' }}>
                  ...
                  {selectedType && (
                    <div className="dc-basic-info-card" style={{ flex: 1, height: 56, alignItems: 'center' }}>
                      ...
                      <div className="dc-basic-info-card__body">
                        <span className="dc-basic-info-card__label">Charges</span>
                        <span className="dc-basic-info-card__value dc-basic-info-card__value--charge">{selectedType.fees}</span>
                      </div>
                    </div>
                  )}
                </div>
