          ...
          <div className="dc-form-card">
            <div className="dc-form-section">
              ...
              <table className="dc-charges__table">
                ...
                <tbody>
                  <tr><td>Custom Warehouse License Fee</td><td><DirhamIcon size={13} color="#0e1b3d" />25,000.00</td></tr>
                  <tr><td>Processing Fee</td><td><DirhamIcon size={13} color="#0e1b3d" />500.00</td></tr>
                </tbody>
                <tfoot>
                  <tr><td><strong>Total</strong></td><td><strong><DirhamIcon size={13} color="currentColor" />25,500.00</strong></td></tr>
                </tfoot>
              </table>
            </div>
          </div>
