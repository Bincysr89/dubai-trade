      ...
      <div className="flex-1 overflow-y-auto px-[40px] py-[24px]">
        <div className="bg-white rounded-[8px] flex flex-col items-center gap-[32px] px-[24px] py-[60px]" style={{ boxShadow: '0px 5px 32px rgba(143,155,186,0.16)' }}>
          ...
          <div className="border border-[#ebebeb] rounded-[5px] px-[16px] py-[10px] flex items-center gap-[12px] flex-wrap justify-center" style={{ fontFamily: "'Dubai', sans-serif" }}>
            <div className="flex items-center gap-[6px]">
              <span className="text-[14px] text-[#696f83]">Claim Request No:</span>
              <span className="text-[14px] text-[#1360d2]" style={{ fontWeight: 500 }}>{claimRequestNo}</span>
            </div>
            <span className="text-[14px] text-[#d5ddfb]">|</span>
            <div className="flex items-center gap-[6px]">
              <span className="text-[14px] text-[#696f83]">Claim No:</span>
              <span className="text-[14px] text-[#1360d2]" style={{ fontWeight: 500 }}>{claimNo}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-[8px]" style={{ fontFamily: "'Dubai', sans-serif" }}>
            ...
            <span className="text-[14px] text-[#455174]">Processing time 3–5 business days.</span>
          </div>

          <div className="flex items-center gap-[12px] flex-wrap justify-center pt-[8px]">
            <button
              onClick={onBack}
              className="h-[48px] px-[24px] rounded-[4px] border border-[#1360d2] bg-white text-[14px] text-[#1360d2] hover:bg-[#1360d2] hover:text-white transition-colors"
            ...
            <button
              ...
              className="h-[48px] px-[24px] rounded-[4px] bg-[#1360d2] text-[14px] text-white hover:bg-[#0f4fab] transition-colors"
              style={{ fontFamily: "'Dubai', sans-serif", fontWeight: 500 }}
            >
            ...
            <button
              onClick={onShare}
              className="h-[48px] px-[24px] rounded-[4px] border border-[#1360d2] bg-white text-[14px] text-[#1360d2] hover:bg-[#1360d2] hover:text-white transition-colors flex items-center gap-[8px]"
              style={{ fontFamily: "'Dubai', sans-serif", fontWeight: 500 }}
            >
