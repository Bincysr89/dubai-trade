      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-10 py-[24px]">
        ...
        >
          ...
          <p className="text-center text-[26px] text-[#0e1b3d]" style={{ fontWeight: 700, lineHeight: 1.3 }}>
            Claim Submitted - ePayment Processing
          </p>

          <div className="text-center text-[#0e1b3d] max-w-[640px]" style={{ lineHeight: 1.9 }}>
            <span style={{ fontSize: 16 }}>
              Your claim request has been submitted. Your ePayment transaction is under processing and will be completed shortly.
            </span>
            <br />
            ...
            <br />
            <span style={{ fontSize: 16 }}>
              You can view the claim status from the listing page after successful ePayment processing.
            </span>
          </div>
          ...
          <div className="flex flex-col items-center gap-[16px] pt-[8px]">
            <div className="flex flex-wrap gap-[16px] justify-center">
              <button
                ...
                style={{ fontFamily: font, fontWeight: 500, fontSize: 16, minWidth: 200 }}
              >
