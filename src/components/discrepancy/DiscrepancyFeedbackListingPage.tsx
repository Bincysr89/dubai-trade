    ...
    <div className="fixed inset-0 z-50 bg-[#f8fafd] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-10 pb-8">
        ...
        <div className="flex items-center gap-[10px] mb-[10px] flex-wrap">
          ...
          <div className="h-[48px] px-[14px] flex items-center rounded-[4px] border border-[#d5ddfb] bg-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 pt-2">
              <div className="relative">
                <input
                  ...
                  placeholder=" "
                  className="h-[56px] w-full rounded-[4px] px-[12px] text-[16px] text-[#0e1b3d] focus:outline-none bg-white peer"
                  style={{ fontFamily: font, border: '1px solid #d5ddfb' }}
                />
                <span className="absolute pointer-events-none text-[12px] text-[#0e1b3d]" style={{ left: 10, top: -9, background: '#fff', padding: '0 4px', fontFamily: font }}>
                  Rotation No. / BOL / MRN
                </span>
              </div>
        ...
        {/* Toolbar row 2 — Import/Export toggle, date-range badge, Columns */}
        <div className="flex items-center gap-[10px] mb-[16px] flex-wrap">
          <div className="inline-flex rounded-[4px] overflow-hidden border border-[#d5ddfb]" style={{ height: 48 }}>
            {(['Import', 'Export'] as ReconciliationType[]).map(t => (
              <button
                key={t}
                onClick={() => { setReconType(t); setSelectedIds(new Set()); }}
                className="px-[22px] text-[16px] transition-colors"
                style={{
                  fontFamily: font,
                  fontWeight: 500,
                  background: reconType === t ? '#1360d2' : '#fff',
                  color: reconType === t ? '#fff' : '#0e1b3d',
                }}
              >
                {t}
              </button>
        ...
        {/* Rotation count + Provide Feedback */}
        <div className="flex items-center justify-between mb-[12px]">
          ...
          <button
            ...
            className="h-[44px] px-[20px] rounded-[4px] text-[16px] text-white transition-colors disabled:cursor-not-allowed"
            ...
            return (
              <div key={g.rotationNo} className="bg-white rounded-[8px] overflow-hidden" style={{ boxShadow: '0px 5px 32px rgba(143,155,186,0.10)' }}>
                ...
                <div className="w-full flex items-center gap-[14px] px-[20px] py-[16px] hover:bg-[#f8fafd] transition-colors">
                  ...
                  <button onClick={() => toggleExpand(g.rotationNo)} className="flex-shrink-0 p-[4px]">
